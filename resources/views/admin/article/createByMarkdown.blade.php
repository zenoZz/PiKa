...
<section class="content">
    <div class="box">
        ...
        <div class="box-body" style="overflow-x: auto;">
            <form class="form-horizontal cmxform" name="createArticleForm" id="form" action="/article/markdown" method="post" enctype="multipart/form-data">
                {!! csrf_field() !!}
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 editor">
                            <textarea class="form-control" rows="5"  id='myEditor' name="content"></textarea>
                        </div>
                    </div>
                </div><!-- /.box-body -->
